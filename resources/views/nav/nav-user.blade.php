<nav class="navbar navbar-expand-lg main-navbar">
    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                ...
                <div class="d-sm-none d-lg-inline-block">Hi, {{ Str::ucfirst(Session::get('login')['name']) }}</div>
            </a>
...
<nav class="navbar navbar-secondary navbar-expand-lg">
    <div class="container">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a href="#" class="nav-link"><i class="far fa-heart"></i><span>Tawaran Job</span></a>
            </li>
            <li class="nav-item">
                <a href="#" class="nav-link"><i class="far fa-clone"></i><span>Job Saya</span></a>
            </li>
